    ...
    public static void main(String[] args){
        ...
        try{
            ...
            if (pilihanMenu == 1){
                ...
                //To Do 5 : Tampilkan pesan bahwa menu tidak valod dan menghentikan eksekusi program
                System.out.println("Menu tidak valid");
            }
            //To Do 6 : Periksa apakah menu yang dipilih tidak null, jika null, seharusnya menimbulkan (throw) MneuTidakTersediaException
            if (menu == null){
